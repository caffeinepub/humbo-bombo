...
export class Backend implements backendInterface {
    ...
    async getGameHistory(): Promise<Array<BetOutcome>> {
        if (this.processError) {
            try {
    ...
    async resolveBet(arg0: string, arg1: string, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resolveBet(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
